"""
This is an example profile adpater for the C-Hack UMS
"""
...
class ProfileAdapter():
    ...
    def get_api_definition_registration(self, std_string_size: int) -> Dict[str, fields.Raw]:
        ...
        """
        return {'c-tag': fields.String(max_length=std_string_size, title='C Tag (C-Hack Nickname)'),
                'e_mail': fields.String(max_length=std_string_size, title='E-Mail Address'),
                'firstname': fields.String(max_length=std_string_size, title='First Name'),
                'lastname': fields.String(max_length=std_string_size, title='Last Name')}
